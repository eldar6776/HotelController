...
// Sadržaj preuzet iz sysctrl.html + NOVE FUNKCIJE + PROTOKOL SELEKCIJA
...
<head>
    ...
    <style>
        ...
        /* Protocol selection highlight */
        .protocol-section { background: #e8f4f8; padding: 10px; border-radius: 5px; }
    </style>
</head>
<body>
    <div class="container">
