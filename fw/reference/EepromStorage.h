...
// NOVO: Struktura za dodatne TimeSync pakete
struct AdditionalTimeSyncConfig
{
    uint16_t broadcast_addr;
...
struct AppConfig
{
    ...
    uint16_t system_id;
    ProtocolVersion main_protocol; // NOVO: Glavni protokol
    char mdns_name[32];
    AdditionalTimeSyncConfig additional_syncs[3]; // NOVO: Dodatni TimeSync paketi
};
